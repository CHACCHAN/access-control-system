...
export function SlidersIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M4 6h9M17 6h3M4 12h3M11 12h9M4 18h9M17 18h3"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
...
export function LinkIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M10 13.5a3.5 3.5 0 0 0 5 0l2.5-2.5a3.5 3.5 0 0 0-5-5L11 7.5M14 10.5a3.5 3.5 0 0 0-5 0L6.5 13a3.5 3.5 0 0 0 5 5L13 16.5"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function GlobeIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18Zm0 0a13.8 13.8 0 0 0 0 18a13.8 13.8 0 0 0 0-18ZM3.5 9h17M3.5 15h17"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function BracesIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M8 4c-1.5 0-2 .8-2 2v3c0 1.2-.6 2.4-2 3 1.4.6 2 1.8 2 3v3c0 1.2.5 2 2 2M16 4c1.5 0 2 .8 2 2v3c0 1.2.6 2.4 2 3-1.4.6-2 1.8-2 3v3c0 1.2-.5 2-2 2"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function HandIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M8 11V5.5a1.5 1.5 0 0 1 3 0V11m0-.5V4.5a1.5 1.5 0 0 1 3 0V11m0-.5V6a1.5 1.5 0 0 1 3 0v7c0 3.3-2.7 6-6 6a6 6 0 0 1-5.3-3.2L5 14.3a1.5 1.5 0 0 1 2.6-1.5L8 13.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="12" cy="13" r="1.6" stroke="currentColor" strokeWidth="1.7" />
    </svg>
  );
}
...
export function PaletteIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M12 21a9 9 0 1 1 9-9c0 1.8-1.2 3-3 3h-1.8c-1.2 0-2.2 1-2.2 2.2 0 .5.2 1 .5 1.4.3.4.5.8.5 1.2 0 .7-.6 1.2-1.3 1.2H12Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M7.5 11.5h.01M10.5 7.5h.01M15.5 7.5h.01M17.5 11.5h.01"
        stroke="currentColor"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
